                        ...
                        <form class="form2" id="form2" method="post">
                          <td><table bgcolor="#FFFFFF" border="0" cellpadding="3" cellspacing="1" width="100%">
                              ...
                              <tr>
							   ...
							   <tr>
                                <td width="">&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size:12px;">State</font></td>
                                <td width="">:</td>
                                <td width="">
								<input name="state" class="forminput" id="txtState" maxlength="20" type="text" placeholder="enter your state" size="30" name="Confirm E-mail Id-repeat"required></td>
                                  </tr>                      
							   <tr>
                                <td width="">&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size:12px;">City</font></td>
                                <td width="">:</td>
                                <td width="">
								<input name="txtdest" class="forminput" id="txtcontact no." maxlength="20" type="text" placeholder="enter your city name" size="30" ></td>
                              </tr>
                               

							   <tr>
                                <td width="">&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size:12px;">Freight</font></td>
                                <td width="">:</td>
                                <td width="">
