...
<footer class="container-fluid" style="background-color:rgb(26,26,26); width:100%;">
     <div class="container">
         <div class="row footer1">
			 ...
			 <div class="col-sm-3">
				 ...
				 <ul class="list-unstyled">
					 ...
					 <li><br><br></li>
					  ...
					  <li><label>Noida sector 64, India</label></li>
				 </ul>
			 </div>
			...
			<div class="col-sm-6">
			<strong  style="float:left;color:gray;"> ©Courier Management System 2024.All right reserved</strong>
			</div>
